...
class EngineDynoExp(DAATAScene, uiFile):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
        self.hide()
        ...
        # self.current_keys = data.get_sensors(is_plottable=True)
        self.current_keys = ["test_sensor_0", "test_sensor_1", "test_sensor_2",
    ...
    def create_graphs(self):
        ...
        self.graph_objects[key] = CustomPlotWidget(key, parent=self.graph_frame,
